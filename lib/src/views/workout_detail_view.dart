...
import '../cubits/states/workout_set_state.dart';
...
class _WorkoutDetailViewState extends State<WorkoutDetailView> {
  ...
  void initState() {
    ...
    context.read<WorkoutSetCubit>().getWorkoutSets(widget.workoutId);
  }
              ...
              return Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      workoutState.error ?? 'Workout not found',
                ...
                return SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      if (setState.isLoading && setState.workoutSets.isEmpty)
                        const Center(child: CircularProgressIndicator())
                      else if (setState.workoutSets.isEmpty)
                        Card(
                          child: Padding(
                        ...
                        ...setState.workoutSets.asMap().entries.map((entry) {
                            ...
                            child: ExpansionTile(
                              ...
                              subtitle: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    '${workoutSet.workoutSet.minSets}${workoutSet.workoutSet.maxSets != null ? '-${workoutSet.workoutSet.maxSets}' : '+'} sets',
                                    style: TextStyle(
                                      fontSize: 14,
                                      color: Colors.grey[600],
                                    ),
                                  ...
                                  if (workoutSet
                                      ...
                                      0)
                                    Text(
                                      'Rest: ${_formatRestTime(workoutSet.workoutSet.recommendedRestSecs)}',
                                      style: TextStyle(
                                        fontSize: 12,
                                        color: Colors.grey[500],
                                      ),
                              ...
                              children: [
                                if (workoutSet.exercises.isEmpty)
                                  const Padding(
                                  ...
                                  ...workoutSet.exercises
                                    ...
                                    final exercise =
                                        exerciseWithExercise.exercise;
                                    final workoutSetExercise =
                                        exerciseWithExercise.workoutSetExercise;
                                    return ListTile(
                                      ...
                                      subtitle: Column(
                                        ...
                                        children: [
                                          Text(
                                            '${workoutSetExercise.minReps}${workoutSetExercise.maxReps != null ? '-${workoutSetExercise.maxReps}' : '+'} reps',
                                            style: TextStyle(
                                              fontSize: 12,
                                              color: Colors.grey[600],
                                            ),
