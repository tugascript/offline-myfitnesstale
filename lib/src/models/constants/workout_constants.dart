    ...
    WorkoutSetData(
      ...
      exercises: [
        WorkoutSetExerciseData(
          ...
          exerciseOptionsNames: [kPullUpsName],
        ),
      ],
    ),
    WorkoutSetData(
    ...
    WorkoutSetData(
      ...
      exercises: [
        WorkoutSetExerciseData(
          ...
          exerciseOptionsNames: [kPullUpsName, kWeightedPullUpName],
        ),
      ],
    ),
    WorkoutSetData(
    ...
    WorkoutSetData(
      ...
      exercises: [
        WorkoutSetExerciseData(
          ...
          exerciseOptionsNames: [kChinUpsName, kWeightedChinUpName],
        ),
      ],
    ),
    WorkoutSetData(
    ...
    WorkoutSetData(
      ...
      exercises: [
        WorkoutSetExerciseData(
          ...
          exerciseOptionsNames: [kChinUpsName, kAssistedChinUpName],
        ),
      ],
    ),
    WorkoutSetData(
    ...
    WorkoutSetData(
      ...
      exercises: [
        WorkoutSetExerciseData(
          ...
          exerciseOptionsNames: [kPullUpsName, kAssistedPullUpName],
        ),
      ],
    ),
    WorkoutSetData(
